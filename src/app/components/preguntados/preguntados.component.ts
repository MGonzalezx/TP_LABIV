...
import { ApiDigimonService } from 'src/app/services/api-digimon.service';
...
export class PreguntadosComponent implements OnInit {
  ...
  smsFinal: boolean = false;
   ...
   //imagenes
   imgDigimon: any;
   tsunomon: any; // 1 comparo de quien es
   birdramon: any; //20 preguntar qué tipo de digimon es
   kabuterimon: any; //22 evolucion de qué digimon es
   wizardmon: any; // 74 preguntar por quien se sacrificó
  ...
  pregunta_05: string[] = ['5', '¿En qué temporada aparece Imperialdramon?', 'Digimon Tamers', 'Digimon Frontier', 'Digimon Adventure 02', 'Digimon Adventure', '4'];
